...
public:
    OrbLine(cv::Mat _previousImage, cv::Mat _currentImage,
      cv::Mat _previousTWC, cv::Mat _currentTWC, double fx, double fy, double cx, double cy, double lineMatchDistanceThres,
...
protected:
    ...
    std::vector<cv::Point2d> refineSearchPoints(cv::Point2d pointInLine, cv::Mat rightLine, cv::Mat F, cv::Mat Rtwc1, cv::Mat Rtwc2);
