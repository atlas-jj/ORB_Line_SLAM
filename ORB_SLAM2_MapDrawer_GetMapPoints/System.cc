...
///////////////chris/////////////////////////////////////////////////////////////////////////////////////
//void System::setPublisher(ros::Publisher & _pub)
//{
//	myPub=_pub;
//
//	mpMapDrawer->setPublisher(_pub);
//}
...
void System::SaveTrajectoryTUM(const string &filename)
{
        ...
        lend=mpTracker->mlRelativeFramePoses.end();lit!=lend;lit++, lRit++, lT++, lbL++)
    {
        ...
        f << (pKF->mnId) << " "<<setprecision(6) << *lT << " " <<  setprecision(9) << twc.at<float>(0) << " " << twc.at<float>(1) << " " << twc.at<float>(2) << " " << q[0] << " " << q[1] << " " << q[2] << " " << q[3] << endl;
    }
    f.close();
